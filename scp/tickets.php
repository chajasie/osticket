    ...
    if($ticket && $ticket->getId()) {
        ...
        case 'reply':
            if(!$thisstaff->canPostReply())
                ...
                if(!$_POST['supportTime'] || !is_numeric($_POST['supportTime']))
                    $errors['supportTime']=__('Bitte eine Dauer angeben');
...
$ost->addExtraHeader('<script type="text/javascript" src="js/ticket.js?9adad36"></script>');
