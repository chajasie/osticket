...
class Ticket {
    ...
    //var $supportTime; //created by Ronald Aus der Au, 02.04.2015
    ...
    function load($id=0) {
        ...
        $this->_answers = array();
        //$this->supportTime = $this->ht['supportTime']; //created by Ronald Aus der Au, 02.04.2015
    ...
    //created by Ronald Aus der Au, 02.04.2015
/*
    function getSupportTime() {
        return $this->ht['supportTime'];
    }
*/
    ...
    //created by Ronald Aus der Au, 02.04.2015
/*
    function setSupportTime($threadSupportTime = 0){
        $ticketSupportTime = $this->getSupportTime();
        $ticketSupportTime += $threadSupportTime;

        $sql='UPDATE '.TICKET_TABLE.' SET supportTime='.db_input($ticketSupportTime)
            .' WHERE ticket_id='.db_input($this->getId());
...
*/
   ...
   function onOverdue($whine=true, $comments="") {
    ...
    function postReply($vars, &$errors, $alert = true) {
        ...
        //$this->setSupportTime($vars['supportTime']);
