        ...
        <table class="thread-entry <?php echo $threadTypes[$entry['thread_type']]; ?>" cellspacing="0" cellpadding="1" width="940" border="0">
            <tr>
                ...
                <div>
					...
					<span><?php if($entry['supportTime'] > 0) echo "[" . $entry['supportTime'] . " min]"; ?></span>
                    </span>
...
<div id="response_options">
    ...
    <form id="reply" action="tickets.php?id=<?php echo $ticket->getId(); ?>#reply" name="reply" method="post" enctype="multipart/form-data">
        ...
        <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
           <tbody id="to_sec">
           <?php
           if($errors['supportTime']) {?>
           <tr><td width="120">&nbsp;</td><td class="error"><?php echo $errors['supportTime']; ?>&nbsp;</td></tr>
           <?php
           }?>
            <tr>
                <td width="120">
                    <label><strong>Dauer in Minuten:</strong></label>
                </td>
                <td>
                    <input type="text" value="<?php echo $info['supportTime']; ?>" name="supportTime" />
                </td>
            </tr>
            <tr>
                <td width="120">
